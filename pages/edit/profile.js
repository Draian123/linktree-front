                ...
                <div className='mt-14'>
                    ...
                    <form onSubmit={saveSocials} className='flex flex-col justify-center items-center'>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            ...
                            <input id="facebook" value={social.facebook} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Facebook ID" />
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/instagram.svg" alt="" />
                            <input id="instagram" value={social.instagram} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Instagram ID" />
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/twt.svg" alt="" />
                            <input id="twitter" value={social.twitter} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Twitter ID" />
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/lnkdn.svg" alt="" />
                            <input id='linkedin' value={social.linkedin} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Linkedin ID" />
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/github.svg" alt="" />
                            <input id='github' value={social.github} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Github ID" />
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/yt.svg" alt="" />
                            <input id='youtube' value={social.youtube} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter YouTube ID @" />
                        </span>
