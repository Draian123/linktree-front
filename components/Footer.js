    ...
    <section aria-label="Site Footer" className=" bg-gray-900 text-white">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              {/* <div className="text-teal-600">
                <img src='/images/logo-min.png' className='w-40' alt='logo'/>
              </div> */}
              ...
              <ul className="flex gap-6 mt-8">
                <li>
                  <Link href="https://www.facebook.com/" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://instagram.com/" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://twitter.com/" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://github.com/Draian123" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://www.youtube.com/" rel="noreferrer" target="_blank" className=" transition hover:opacity-75">
              ...
              <div>
                ...
                <nav aria-label="Footer Navigation - Services" className="mt-6">
                  <ul className="space-y-4 text-sm">
                    <li>
                      <Link href="/analystics" className="text-gray-300 transition hover:opacity-75">
                        Analystics
                      </Link>
                    </li>
                    <li>
                      <Link href="/templates" className="text-gray-300 transition hover:opacity-75">
                        Templates
                      </Link>
                    </li>
                  </ul>
          ...
          <p className="text-xs text-gray-500">
            NextJS Project created with ❤️ by <Link href="/" className="text-gray-500 transition hover:opacity-75">Dennis Beitel</Link>
          </p>
        </div>
      </section>
    </footer>
